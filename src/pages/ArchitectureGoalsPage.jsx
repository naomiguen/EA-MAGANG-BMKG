  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-primary-50 flex flex-col items-center justify-center">
        ...
        <p className="text-primary-800 font-medium">Memuat Data Arsitektur...</p>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-primary-50 flex flex-col items-center justify-center p-4">
        <div className="bg-white p-8 rounded-2xl shadow-xl text-center max-w-md border border-red-100">
          ...
          <h3 className="text-xl font-bold text-primary-900 mb-2">Terjadi Kesalahan</h3>
          <p className="text-primary-800 mb-6">{errMsg}</p>
          <button
    ...
    <div className="min-h-screen bg-primary-50">
      ...
      <div className="max-w-6xl mx-auto mb-16">
        <div className="text-center space-y-4">
          <h1 className="text-4xl md:text-5xl font-bold text-primary-700 tracking-tight">
            Architecture Goals
          </h1>
      ...
      <div className="max-w-6xl mx-auto">
        {domainGoals.length === 0 ? (
          <div className="text-center py-12 text-primary-800 bg-white rounded-xl shadow-sm">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {domainGoals.map((item, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-primary-200 group flex flex-col h-full"
              >
                {/* Header dengan Gradient Primary */}
                <div className="bg-gradient-to-r from-primary-700 to-primary-500 p-6 relative overflow-hidden">
                ...
                <div className="p-6 space-y-4 flex-grow flex flex-col">
                  {/* Focus Area */}
                  <div className="bg-primary-50 border-primary-300 border-l-4 p-4 rounded-lg">
                  ...
                  {/* Description */}
                  <p className="text-primary-800 leading-relaxed flex-grow">
                    {item.desc}
                  </p>

                  {/* Divider */}
                  <div className="h-px bg-gradient-to-r from-transparent via-primary-200 to-transparent my-4"></div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {item.goals.length > 0 ? (
                        item.goals.map((goal, idx) => (
                          <span
                            key={idx}
                            className="inline-flex items-center gap-1.5 text-sm bg-primary-100 hover:bg-primary-200 text-primary-700 px-3 py-2 rounded-lg border border-primary-200 transition-colors"
                          >
      ...
      <div className="max-w-6xl mx-auto mt-12">
        <div className="bg-white rounded-xl p-6 border border-primary-200 shadow-sm">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 bg-secondary-500 rounded-xl flex items-center justify-center text-2xl flex-shrink-0">
              💡
            </div>
            <div>
