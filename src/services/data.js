...
export const appData = [
  ...
  // },
  {
    ...
    logoUrl: "https://hfctpsuwjytwyhrdoggb.supabase.co/storage/v1/object/public/usecase/logobmkg.png",
    diagramUrl: "/ucd/UC-WIGOS-FIX.svg",
    useCaseDetails: {
      "AC1": { title: "Registrasi stasiun", description: "Administrator bisa mendaftarkan stasiun dimana saja. National Focal Point, Metadata editors, station contact, masing-masing mendaftarkan stasiun di negara mereka. Network focal point dimana saja, jika terafiliasi dengan jaringan sendiri" },
      "AC2": { title: "Mengedit stasiun", description: "Administrator bisa mengedit stasiun dimana saja. National Focal point dan metadata editors masing-masing mengedit seluruh stasiun di negara mereka. Station contact hanya bisa mengedit stasiun mereka sendiri. Network Focal Point mengedit stasiun yang terafiliasi dengan jaringan mereka." },
      "AC3": { title: "Membuat akun pengguna", description: "Administrator bisa membuat akun pengguna dimana saja, sedangkan National Focal Point, Metadata editors, station contact, dan network focal point hanya bisa membuatkan akun pengguna di negara mereka." },
      "P1": { title: "Mencari stasiun observasi", description: "Pengguna umum dapat mencari stasiun di berbagai negara" },
      "P2": { title: "Melihat informasi stasiun", description: "Mulai dari nama stasiun, lokasi, laporan stasiun, dll" },
      "P3": { title: "Mencari kontak by name", description: "Pengguna umum dapat mencari berdasarkan nama, baik dengan memasukkan nama secara manual maupun menggunakan menu drop-down untuk menelusuri entri." },
      "P4": { title: "Memfilter map berdasarkan WIGOS dan CO-Sponsored komponen", description: "Pengguna umum dapat memfilter dari berbagai masing-masing komponen, seperti  GOS, GAW, WHOS, GCW, GCOOS, GOOS, GTOS" },
      "P5": { title: "Mencari referensi bibliografi", description: "Admin instansi dapat mereset passwordmemungkinkan pengguna untuk menemukan referensi bibliografi yang terkait dengan stasiun. Referensi bibliografi dapat memberikan sumber informasi tambahan yang penting, terutama terkait laporan teknis atau literatur lainnya." },
      "P6": { title: "Mencari instrumen", description: "Seorang pengguna dapat mencari data berdasarkan pabrikan, model, nomor seri, dan periode pengamatan suatu instrumen." },
      "A1": { title: "Menyetujui mengubah nama stasiun", description: "-" },
      "A2": { title: "Menghapus atau menonaktifkan user", description: "Administrator dapat menghapus atau menonaktifkan user dari mana saja. National Focal point hanya bisa menghapus atau menonaktifkan user dari negara mereka saja" },
      "A3": { title: "Menghapus stasiun", description: "Administrator bisa menghapus stasiun dimana saja. National Focal Point dan Metadata editors meminta penghapusan stasiun di negara mereka" },
      "A4": { title: "Mengubah nama stasiun", description: "-" }
  }
  },
  {
    id: "srikandi",
    ...
    description: "Aplikasi dengan integrasi global yang dikembangkan oleh Organisasi Meteorologi Dunia (WMO) untuk menyatukan seluruh sistem pengamatan cuaca, iklim, dan hidrologi dari berbagai negara anggota ke dalam satu kerangka kerja yang terstandarisasi.",
    logoUrl: "https://hfctpsuwjytwyhrdoggb.supabase.co/storage/v1/object/public/usecase/logobmkg.png",
    diagramUrl: "/ucd/UC-SRIKANDI-FIX.svg",
    useCaseDetails: {
      "AN1": { title: "Memasukkan nama instansi", description: " " },
      "AN2": { title: "Memasukkan nama admin instansi", description: "Membuat unit kerja di dalam aplikasi SRIKANDI sesuai struktur organisasi instansi;" },
      "AN3": { title: "Membuat user dan password untuk admin instansi", description: " " },
      "AN4": { title: "Melakukan reset dan password untuk admin instansi", description: "Admin nasional dapat mereset akun admin instansi" },
      "AI1": { title: "Membuat unit kerja sesuai struktur organisasi", description: "Membuat unit kerja di dalam aplikasi SRIKANDI sesuai struktur organisasi instansi" },
      "AI2": { title: "Membuat akun unit dan akun user", description: "Admin instansi membuat akun Unit Kearsipan/Pusdatin, pencatat surat, sekretaris, dan akun pengguna/user (pejabat dan pegawai) di lingkungan instansi" },
      "AI3": { title: "Membuat pengaturan logo instansi", description: "Membuat pengaturan logo instansi menggunakan format (PNG)" },
      "AI4": { title: "Melakukan reset password", description: "Admin instansi dapat mereset password" },
      "TU1": { title: "Registrasi surat dinas", description: "Melakukan Registrasi surat dinas dari eksternal/surat masuk baik dalam bentuk hard copy, email, whatsapp atau media sosial lainnya." },
      "TU2": { title: "Mengatur penomoran naskah", description: "Membuat pengaturan penomoran naskah dinas otomatis" },
      "TU3": { title: "Mengatur daftar verifikator, daftar penandatanganan, dan tujuan naskah", description: "melakukan pengaturan daftar verifikator, daftar penandatangan, dan tujuan naskah untuk seluruh akun pengguna/user yang berada dalam unit kerjanya" },
      "UK1": { title: "Mengatur kolom isian naskah", description: "Membuat pengaturan kolom isian: jenis naskah, sifat naskah, tingkat urgensi, dan instruksi serta disposisi pimpinan" },
      "UK2": { title: "Mengklasifikasikan arsip fasilitatif dan substantif", description: "Membuat klasifikasi arsip fasilitatif dan substantif berdasarkan peraturan Klasifikasi Arsip yang berlaku di instansi" },
      "UK3": { title: "Mengupload template naskah dinas", description: "Membuat dan melakukan upload template naskah dinas sesuai Tata Naskah Dinas yang berlaku di instansi dengan menggunakan forman (DOCX)" },
      "UK4": { title: "Menghapus arsip elektronik yang sudah diberkaskan", description: "Melakukan pemusnahan terhadap arsip elektronik yang telah diberkaskan dalam aplikasi SRIKANDI." },
      "P1": { title: "Membuat surat konsep", description: "Membuat konsep surat, mengirim dan menerima naskah dinas" },
      "P2": { title: "Melakukan disposisi naskah dinas", description: "Memberikan disposisi atau menindaklajuti naskah dinas" },
      "P3": { title: "Melakukan verifikasi naskah dinas", description: "Melakukan verifikasi naskah dinas sesuai kewenangan user" },
      "P4": { title: "Menandatangani naskah dinas", description: "Menandatangani naskah dinas sesuai kewenangan user" },
      "P5": { title: "Menyetujui naskah dinas", description: "user dapat menyetujui naskah dinas yang diterima" },
      "P6": { title: "Menolak naskah dinas", description: "User dapat menolak surat yang salah" }
}
